...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    window.rootViewController = [[TPDrawerViewController alloc] initWithLeftViewController:[TPLeftViewController new] centerViewController:[ViewController defaultPlainViewController]];
